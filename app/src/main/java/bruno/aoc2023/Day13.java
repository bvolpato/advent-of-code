...
public class Day13 {
    ...
    public static void main(String[] args) throws IOException, UnsupportedFlavorException {
        String clipboard = MyStringUtils.getContent(Day13.class.getResourceAsStream("/2023/day13.txt"));
    ...
    private static int getMirrors(char[][] grid, boolean smudge) {
        for (int left = 0; left < grid.length - 1; left++) {
            ...
            System.out.println("(" + left + "," + right + ") Matches is " + (matches) + " at (" + left + "," + right + ") but left is " + left + " or " + grid.length);
