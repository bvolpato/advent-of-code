...
public class Day07 {
  ...
  static class Hand {
    ...
    public String toString() {
      return "Hand{" + "type=" + type + ", card=" + card + ", second=" + second + '}';
    }
  }

  public static void main(String[] args) throws IOException {
    String clipboard = readDay(2023, 7);
    System.out.println("Clipboard content: " + clipboard);

    List<String> listLines = AOCReader.lines(clipboard);
    ...
    for (int i = 0; i < hands.size(); i++) {
      System.out.println(
          hands.get(i).original + ": " + hands.get(i) + ", " + hands.get(i).bet + " * " + (i + 1));
