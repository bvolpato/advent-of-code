 ...
 *
 * <p>Santa was hoping for a white Christmas, but his weather machine's "snow" function is powered
 * by stars, and he's fresh out! To save Christmas, he needs you to collect fifty stars by December
 * 25th.
 *
 * <p>Collect stars by helping Santa solve puzzles. Two puzzles will be made available on each day
 * in the Advent calendar; the second puzzle is unlocked when you complete the first. Each puzzle
 * grants one star. Good luck!
 *
 * <p>Here's an easy puzzle to warm you up.
 *
 ...
 * <p>For example:
 *
 * <p>(()) and ()() both result in floor 0. ((( and (()(()( both result in floor 3. ))((((( also
 * results in floor 3. ()) and ))( both result in floor -1 (the first basement level). ))) and
 * )())()) both result in floor -3.
 *
 * <p>To what floor do the instructions take Santa?
 *
 * <p>Your puzzle answer was 138. --- Part Two ---
 *
 * <p>Now, given the same instructions, find the position of the first character that causes him to
